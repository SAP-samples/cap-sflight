...
describe('Basic OData', () => {
  ...
  it('GET /processor/Travel', async () => {
    ...
    expect(data.value).to.containSubset([{
      ...
      BookingFee: 60,
      createdAt: expectedValue => /2022-07-10T18:42:07\.000(0000)?Z/.test(expectedValue), // REVISIT: expect only 7 fractional digits with cds^7
      createdBy: 'Hansmann',
      ...
      IsActiveEntity: true,
      LastChangedAt: expectedValue => /2022-07-21T03:18:18\.000(0000)?Z/.test(expectedValue), // REVISIT: expect only 7 fractional digits with cds^7
