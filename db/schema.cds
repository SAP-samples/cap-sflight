...
entity Travel : managed {
  key TravelUUID   : UUID;
      ...
      @mandatory: (TravelStatus.code = 'A') // TODO does not show error on UI, yet because the errors message not returned as part of OData action (draft vs. persistence service)
